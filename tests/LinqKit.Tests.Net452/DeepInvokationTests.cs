...
{
    public class DeepInvokationTests
    {
        public class Repository
        {
            ...
            protected static Expression<Func<AuditDocument<SampleDocument>, bool>> EntityFilter(
                Expression<Func<SampleDocument, bool>> filter) 
            {
            ...
            private static Expression<Func<TParent, bool>> PropFilter<TParent, TChild>(
                Expression<Func<TParent, TChild>> selector, Expression<Func<TChild, bool>> filter)
            {
